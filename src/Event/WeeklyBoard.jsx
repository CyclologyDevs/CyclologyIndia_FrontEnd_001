...
class WeeklyBoard extends Component {
    ...
    async componentDidMount() {
        ...
        const res = await fetch('http://19bf-202-8-112-185.ngrok.io/events/event001')
        if (res.ok) {
        ...
        return users.length > 0 ? (
            ...
            <div className='bg-gray-800'>
                ...
                <section className="text-gray-500 body-font font-serif">
                    <div className="container mx-auto flex px-5 py-24 md:flex-row items-center">
                        <div class="col-lg-6 col-md-6 col-sm-12 p-0 ml-0 md:ml-20">
                            <h2 class="display-3 text-center my-3 font-bold text-violet-700" style={{ fontFamily: 'Lobster' }}>No Users</h2>
                        </div>
                    </div>
                </section >
